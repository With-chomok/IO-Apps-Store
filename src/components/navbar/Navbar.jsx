  ...
  return (
    <div className="navbar  bg-base-100 shadow-sm ">
      <div className="navbar-start md:ml-20">
        ...
        <div className="flex ">
          <Link to='./home'  className=" flex items-center gap-2 text-xl font-medium ">
            ...
            <Link to='./home'  className="bg-gradient-to-l from-[#9F62F2] to-[#632EE3] bg-clip-text text-transparent ">
              HERO.IO
            </Link>
          </Link>
        </div>
      ...
      <div className="navbar-end  md:mr-20">
        <Link className="btn bg-gradient-to-l from-[#9F62F2] to-[#632EE3] text-white">
